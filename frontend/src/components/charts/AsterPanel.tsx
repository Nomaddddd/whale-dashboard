...
import type { AsterExchangeData } from '../../types/api'
...
interface AsterPanelProps {
  data: AsterExchangeData
}

export function AsterPanel({ data }: AsterPanelProps) {
          ...
          {data.oi && (
            <div className="pt-3">
              ...
              <div className="divide-y divide-border">
                <StatRow label="OI" value={fmtUsd(data.oi.oi)} />
                <StatRow label="Timestamp" value={fmtTime(data.oi.ts)} />
              </div>
            </div>
          )}
